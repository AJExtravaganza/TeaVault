...
class TeaProducer {
  ...
  Map<String, String> asMap() => {'name': this.name, 'short_name': this.shortName, 'submitted_by_user_with_profile_id': this.isCustom ? authService.lastKnownUserProfileId : null};
  ...
  static TeaProducer fromDocumentSnapshot(DocumentSnapshot producerDocument) {
    ...
    return TeaProducer(data['name'], data['short_name'], producerDocument.documentID, data['submitted_by_user_with_profile_id']);
  }
