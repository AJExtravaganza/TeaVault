...
class TeaProduction {
  ...
  TeaProduction(this.name, this.nominalWeightGrams, this._producerId, this.productionYear, [this.submittedByUserWithProfileId, this.id]);
  ...
  static TeaProduction fromDocumentSnapshot(DocumentSnapshot productionDocument) {
    ...
    final newProduction = TeaProduction(data['name'], data['nominal_weight_grams'], data['producer'], data['production_year'],
        data['submitted_by_user_with_profile_id'], productionDocument.documentID);
